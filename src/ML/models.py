...
class Models(object):
    ...
    def feature_engineer(self):
        ...
        # 新增加了一个shuffle参数，因为autoencoder预测的时候打乱顺序会使整个训练数据乱掉
    ...
    def unbalance_helper(self,
        ...
        #===============================看特征工程有无问题2021.2.27================================
        self.X_train.to_pickle(config.root_path + "/data/X_train.pkl")
        self.y_train.to_pickle(config.root_path + "/data/y_train.pkl")
        #=======================================================================================
        model_name = None
