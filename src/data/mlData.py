...
class MLData(object):
    ...
    def preprocessor(self):
        ...
        # 将验证集中的label名字映射到标签并保存到列labelIndex中
...
#     Data = MLData(debug_mode=True)
#     # Data.train.to_csv(config.root_path + "/data/Debug_data1.csv")
#     # Data.train_tfidf.to_csv(config.root_path + "/data/Debug_tfidf_feature.csv")
#
#     Data.train.to_pickle(config.root_path + "/data/Debugdata2.pkl")
#     # # pd.read_pickle(config.root_path + "/data/Debug_data1.pkl")
#     # Data.train_tfidf.to_pickle(config.root_path + "/data/Debug_tfidffeature.pkl")
#     # dd = pd.read_pickle(config.root_path + "/data/Debug_data1.pkl")
